...
# HowTo for configuring the Mellow SHT-36 and SHT_42 CAN bus tool boards for Klipper. 
...
make menuconfig
```
- Set the following options for CAN bus connection     
![Menu Config CAN BUS](./images/makemenuconfig_screenshot.png)
...
- Klipper CAN bus configuration
 - Finding the CAN bus_uuid for new micro-controllers¶
...
The CAN bus needs to red 60 ohms across the L and H wires.       
